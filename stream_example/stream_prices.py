...
class PriceStreamer(StreamBase):
    ...
    def fire_event(self, instrument):
    ...
    def update_live_price(self, live_price: LiveApiPrice):
        try:
            ...
            self.fire_event(live_price.instrument)
    ...
    def run(self):
        ...
        start = timer() - PriceStreamer.LOG_FREQUENCY + 10
        ...
        for price in resp.iter_lines():
            if price:
                ...
                if 'type' in decoded_price and decoded_price['type'] == 'PRICE':
                    ...
                    if timer() - start > PriceStreamer.LOG_FREQUENCY:
